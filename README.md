...
1. Clone the repo:
   ```sh
   git clone https://[https://github.com/MihhirD/FindAJob.git]
   ```
...
Mihhir Dhar - [GitHub](https://github.com/MihhirD)

Project Link: [https://github.com/MihhirD/FindAJob.git]((https://github.com/MihhirD/FindAJob.git))
